    ...
    <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
        <a href="{{ route('student.dashboard') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                  {{ $currentRoute === 'student.dashboard' ? 'bg-green-700 text-white' : 'text-gray-600 hover:bg-gray-50' }}">
        ...
        <a href="{{ route('student.grades') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                  {{ $currentRoute === 'student.grades' ? 'bg-green-700 text-white' : 'text-gray-600 hover:bg-gray-50' }}">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('student.profile') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                  {{ $currentRoute === 'student.profile' ? 'bg-green-700 text-white' : 'text-gray-600 hover:bg-gray-50' }}">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
